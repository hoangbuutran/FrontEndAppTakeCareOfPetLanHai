...
export class QuyenService {
    ...
    create(quyen: QuyenModel) {
        this.url = 'http://petslike.somee.com/api/quyen/create';
        return this.apiService.post(this.url, quyen);
    }

    KhoaMo(quyenId: number | string): Observable<QuyenModel> {
        this.url = 'http://petslike.somee.com/api/quyen/khoamo/' + quyenId;
        return this.apiService.get(this.url);
    }

    delete(quyenId: number | string): Observable<QuyenModel> {
        this.url = 'http://petslike.somee.com/api/quyen/delete/' + quyenId;
        return this.apiService.get(this.url);
    }
    Update(quyen: QuyenModel) {
        this.url = 'http://petslike.somee.com/api/quyen/update';
        return this.apiService.put(this.url, quyen);
    }

    view(quyenId: number | string): Observable<QuyenModel> {
        this.url = 'http://petslike.somee.com/api/quyen/getbyid/' + quyenId;
        return this.apiService.get(this.url);
    }
    countQuyen() {
        this.url = 'http://petslike.somee.com/api/quyen/listcountquyen';
        return this.apiService.get(this.url);
    }
    ...
    QuyenList() {
        this.url = 'http://petslike.somee.com/api/quyen/getall';
