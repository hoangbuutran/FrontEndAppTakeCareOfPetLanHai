...
export class PhieuHenKhamService {
    ...
    duyetPhieuHenKham(phieuHenKhamId: number | string): Observable<any> {
        this.url = 'http://localhost:1650/api/phieu-hen-kham/duyet-phieu-hen-kham/' + phieuHenKhamId;
        return this.apiService.get(this.url);
    }

    tuChoiPhieuHenKham(phieuHenKhamId: number | string): Observable<any> {
        this.url = 'http://localhost:1650/api/phieu-hen-kham/tu-choi-phieu-hen-kham/' + phieuHenKhamId;
        return this.apiService.get(this.url);
    }

    create(phieuHenKham: any): Observable<any> {
        this.url = 'http://localhost:1650/api/phieu-hen-kham/create';
        return this.apiService.post(this.url, phieuHenKham);
    }

    phieuVoiNgay(phieuVoiNgay: any): Observable<any> {
        this.url = 'http://localhost:1650/api/phieu-hen-kham/phieu-voi-ngay';
        return this.apiService.post(this.url, phieuVoiNgay);
    }

    delete(phieuHenKhamId: number | string): Observable<any> {
        this.url = 'http://localhost:1650/api/phieu-hen-kham/delete/' + phieuHenKhamId;
        return this.apiService.get(this.url);
    }

    Update(phieuHenKham: any) {
        this.url = 'http://localhost:1650/api/phieu-hen-kham/update';
        return this.apiService.put(this.url, phieuHenKham);
    }

    view(phieuHenKhamId: number | string): Observable<any> {
        this.url = 'http://localhost:1650/api/phieu-hen-kham/get-by-id/' + phieuHenKhamId;
        return this.apiService.get(this.url);
    }

    viewphieuHenKhamVoiCSYT(cSYTId: number | string): Observable<any> {
        this.url = 'http://localhost:1650/api/phieu-hen-kham/get-all-with-id-cosothuy/' + cSYTId;
        return this.apiService.get(this.url);
    }
    ...
    viewphieuHenKhamVoiIdNguoiDung(idNguoiDung: number | string): Observable<any> {
        this.url = 'http://localhost:1650/api/phieu-hen-kham/get-all-with-id-nguoi-dung/' + idNguoiDung;
        return this.apiService.get(this.url);
    }
