...
export class ChuyenMucService {
    ...
    create(chuyenMuc: any): Observable<any> {
        this.url = 'http://petslike.somee.com/api/chuyenmuc/create';
        return this.apiService.post(this.url, chuyenMuc);
    }

    KhoaMo(chuyenMucId: number | string): Observable<any> {
        this.url = 'http://petslike.somee.com/api/chuyenmuc/khoamo/' + chuyenMucId;
        return this.apiService.get(this.url);
    }

    delete(chuyenMucId: number | string): Observable<any> {
        this.url = 'http://petslike.somee.com/api/chuyenmuc/delete/' + chuyenMucId;
        return this.apiService.get(this.url);
    }
    Update(chuyenMuc: ChuyenMucModel) {
        this.url = 'http://petslike.somee.com/api/chuyenmuc/update';
        return this.apiService.put(this.url, chuyenMuc);
    }

    view(chuyenMucId: number | string): Observable<any> {
        this.url = 'http://petslike.somee.com/api/chuyenmuc/getbyid/' + chuyenMucId;
        return this.apiService.get(this.url);
    }

    countchuyenMuc(): Observable<any> {
        this.url = 'http://petslike.somee.com/api/chuyenmuc/listcountchuyenmuc';
        return this.apiService.get(this.url);
    }
    ...
    chuyenMucList() {
        this.url = 'http://petslike.somee.com/api/chuyenmuc/getall';
