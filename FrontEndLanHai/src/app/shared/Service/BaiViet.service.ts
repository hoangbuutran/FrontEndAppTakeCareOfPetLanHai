...
export class BaiVietService {
    ...
    create(baiViet: any): Observable<any> {
        this.url = 'http://petslike.somee.com/api/baiviet/create';
        return this.apiService.post(this.url, baiViet);
    }

    delete(baiVietId: number | string): Observable<any> {
        this.url = 'http://petslike.somee.com/api/baiviet/delete/' + baiVietId;
        return this.apiService.get(this.url);
    }

    view(baiVietId: number | string): Observable<any> {
        this.url = 'http://petslike.somee.com/api/baiviet/getbyid/' + baiVietId;
        return this.apiService.get(this.url);
    }

    KhoaMo(baivietId: number | string): Observable<any> {
        this.url = 'http://petslike.somee.com/api/baiviet/khoamo/' + baivietId;
        return this.apiService.get(this.url);
    }


    Update(baiViet: BaiVietModel) {
        this.url = 'http://petslike.somee.com/api/baiviet/update';
        return this.apiService.put(this.url, baiViet);
    }

    viewbaiVietVoiIdNguoiDung(idNguoiDung: number | string) {
        this.url = 'http://petslike.somee.com/api/baiviet/getallbaiVietwithidBaiViet/' + idNguoiDung;
    ...
    viewListBaiViet() {
        this.url = 'http://petslike.somee.com/api/baiviet/getallbaiViet';
        return this.apiService.get(this.url).subscribe(res => {
