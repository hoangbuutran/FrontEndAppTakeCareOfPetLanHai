...
export class CoSoThuYService {
    ...
    create(coSoThuY: any): Observable<any> {
        this.url = 'http://localhost:1650/api/cosothuy/create';
        return this.apiService.post(this.url, coSoThuY);
    }

    KhoaMo(coSoThuYId: number | string): Observable<any> {
        this.url = 'http://localhost:1650/api/cosothuy/khoamo/' + coSoThuYId;
        return this.apiService.get(this.url);
    }

    delete(coSoThuYId: number | string): Observable<any> {
        this.url = 'http://localhost:1650/api/cosothuy/delete/' + coSoThuYId;
        return this.apiService.get(this.url);
    }
    Update(coSoThuY: CoSoThuYModel) {
        this.url = 'http://localhost:1650/api/cosothuy/update';
        return this.apiService.put(this.url, coSoThuY);
    }

    view(coSoThuYId: number | string): Observable<any> {
        this.url = 'http://localhost:1650/api/cosothuy/getbyid/' + coSoThuYId;
        return this.apiService.get(this.url);
    }

    viewWithIdTaiKhoan(taiKhoanId: number | string): Observable<any> {
        this.url = 'http://localhost:1650/api/cosothuy/getbyidtaikhoan/' + taiKhoanId;
        return this.apiService.get(this.url);
    }

    countCoSoThuY(): Observable<any> {
        this.url = 'http://localhost:1650/api/cosothuy/listcountcosothuy';
        return this.apiService.get(this.url);
    }
    ...
    xemTaiKhoanCoSoThuY(coSoThuYId: number | string): Observable<any> {
        this.url = 'http://localhost:1650/api/taikhoan/getbyid/' + coSoThuYId;
        return this.apiService.get(this.url);
    }

    coSoThuYList() {
        this.url = 'http://localhost:1650/api/cosothuy/getall';
