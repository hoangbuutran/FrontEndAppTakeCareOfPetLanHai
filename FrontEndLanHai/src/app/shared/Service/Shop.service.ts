...
export class ShopService {
    ...
    create(shop: any): Observable<any> {
        this.url = LinkServerModel.URL + 'api/shop/create';
        return this.apiService.post(this.url, shop);
    }

    KhoaMo(shopId: number | string): Observable<any> {
        this.url = LinkServerModel.URL + 'api/shop/khoamo/' + shopId;
        return this.apiService.get(this.url);
    }

    Duyet(shopId: number | string): Observable<any> {
        this.url = LinkServerModel.URL + 'api/shop/duyet/' + shopId;
        return this.apiService.get(this.url);
    }

    TuChoi(shopId: number | string): Observable<any> {
        this.url = LinkServerModel.URL + 'api/shop/tuchoi/' + shopId;
        return this.apiService.get(this.url);
    }

    delete(shopId: number | string): Observable<any> {
        this.url = LinkServerModel.URL + 'api/shop/delete/' + shopId;
        return this.apiService.get(this.url);
    }
    Update(shop: ShopModel) {
        this.url = LinkServerModel.URL + 'api/shop/update';
        return this.apiService.put(this.url, shop);
    }

    view(shopId: number | string): Observable<any> {
        this.url = LinkServerModel.URL + 'api/shop/getbyid/' + shopId;
        return this.apiService.get(this.url);
    }

    viewListShop() {
        this.url = LinkServerModel.URL + 'api/shop/getall';
    ...
    viewListShopChuaDuyet() {
        this.url = LinkServerModel.URL + 'api/shop/chuapheduyet';
        this.apiService.get(this.url).subscribe(res => {
    ...
    viewShopVoiIDTaiKhoan(taiKhoanId: number | string): Observable<any> {
        this.url = LinkServerModel.URL + 'api/shop/getbyidtaikhoan/' + taiKhoanId;
        return this.apiService.get(this.url);
    }
    xemTaiKhoanShop(ShopId: number | string): Observable<any> {
        this.url = LinkServerModel.URL + 'api/taikhoan/getbyid/' + ShopId;
        return this.apiService.get(this.url);
    }
    countshop(): Observable<any> {
        this.url = LinkServerModel.URL + 'api/shop/listcountshop';
        return this.apiService.get(this.url);
    }
