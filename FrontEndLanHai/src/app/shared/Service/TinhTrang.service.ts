...
export class TinhTrangService {
    ...
    create(tinhTrang: any): Observable<any> {
        this.url = 'http://takecareofthepet.somee.com/api/tinhtrang/create';
        return this.apiService.post(this.url, tinhTrang);
    }

    KhoaMo(tinhTrangId: number | string): Observable<any> {
        this.url = 'http://takecareofthepet.somee.com/api/tinhtrang/khoamo/' + tinhTrangId;
        return this.apiService.get(this.url);
    }

    delete(tinhTrangId: number | string): Observable<any> {
        this.url = 'http://takecareofthepet.somee.com/api/tinhtrang/delete/' + tinhTrangId;
        return this.apiService.get(this.url);
    }
    Update(tinhTrang: TinhTrangModel) {
        this.url = 'http://takecareofthepet.somee.com/api/tinhtrang/update';
        return this.apiService.put(this.url, tinhTrang);
    }

    view(tinhTrangId: number | string): Observable<any> {
        this.url = 'http://takecareofthepet.somee.com/api/tinhtrang/getbyid/' + tinhTrangId;
        return this.apiService.get(this.url);
    }

    viewtinhTrangVoiIdThuCung(idThuCung: number | string) {
        this.url = 'http://takecareofthepet.somee.com/api/tinhtrang/getalltinhtrangbyidthucung/' + idThuCung;
    ...
    counttinhTrang(): Observable<any> {
        this.url = 'http://takecareofthepet.somee.com/api/tinhtrang/listcounttinhTrang';
        return this.apiService.get(this.url);
    }
    ...
    tinhTrangList() {
        this.url = 'http://takecareofthepet.somee.com/api/tinhtrang/getall';
