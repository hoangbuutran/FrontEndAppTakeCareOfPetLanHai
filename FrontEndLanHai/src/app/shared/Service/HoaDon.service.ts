...
export class HoaDonService {
    ...
    create(hoaDon: any): Observable<any> {
        this.url = 'http://takecareofpets.somee.com/api/hoadon/create';
        return this.apiService.post(this.url, hoaDon);
    }

    updateTrangThai(hoaDonId: number | string): Observable<any> {
        this.url = 'http://takecareofpets.somee.com/api/hoadon/updatetrangthai/' + hoaDonId;
        return this.apiService.get(this.url);
    }

    delete(HoaDonId: number | string): Observable<any> {
        this.url = 'http://takecareofpets.somee.com/api/hoadon/delete/' + HoaDonId;
        return this.apiService.get(this.url);
    }

    Update(HoaDon: HoaDonModel) {
        this.url = 'http://takecareofpets.somee.com/api/hoadon/update';
        return this.apiService.put(this.url, HoaDon);
    }

    view(HoaDonId: number | string): Observable<any> {
        this.url = 'http://takecareofpets.somee.com/api/hoadon/getbyid/' + HoaDonId;
        return this.apiService.get(this.url);
    }

    countHoaDon(idShop: number): Observable<any> {
        this.url = 'http://takecareofpets.somee.com/api/hoadon/listcounthoadonshop/' + idShop;
        return this.apiService.get(this.url);
    }
    ...
    viewHoaDonVoiIdShop(idShop: number) {
        this.url = 'http://takecareofpets.somee.com/api/hoadon/getallbyidshop/' + idShop;
        return this.apiService.get(this.url);
    }

    viewCTHoaDonVoiIdHoaDon(idHoaDon: number) {
        this.url = 'http://takecareofpets.somee.com/api/hoadon/getallcthdbyidhoadon/' + idHoaDon;
        return this.apiService.get(this.url);
    }
