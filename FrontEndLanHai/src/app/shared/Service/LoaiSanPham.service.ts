...
export class LoaiSanPhamService {
    ...
    create(loaiSanPham: any): Observable<any> {
        this.url = 'http://petslike.somee.com/api/loaisanpham/create';
        return this.apiService.post(this.url, loaiSanPham);
    }

    KhoaMo(loaiSanPhamId: number | string): Observable<any> {
        this.url = 'http://petslike.somee.com/api/loaisanpham/khoamo/' + loaiSanPhamId;
        return this.apiService.get(this.url);
    }

    delete(loaiSanPhamId: number | string): Observable<any> {
        this.url = 'http://petslike.somee.com/api/loaisanpham/delete/' + loaiSanPhamId;
        return this.apiService.get(this.url);
    }
    Update(loaiSanPham: LoaiSanPhamModel) {
        this.url = 'http://petslike.somee.com/api/loaisanpham/update';
        return this.apiService.put(this.url, loaiSanPham);
    }

    view(loaiSanPhamId: number | string): Observable<any> {
        this.url = 'http://petslike.somee.com/api/loaisanpham/getbyid/' + loaiSanPhamId;
        return this.apiService.get(this.url);
    }

    viewForTrue(idShop: number | string): Observable<any> {
        this.url = 'http://petslike.somee.com/api/loaisanpham/getallbyidshopfortrue/' + idShop;
        return this.apiService.get(this.url);
    }

    countLoaiSanPham(idShop: number): Observable<any> {
        this.url = 'http://petslike.somee.com/api/loaisanpham/listcountloaisanphamwithidshop/' + idShop;
        return this.apiService.get(this.url);
    }
    ...
    viewLoaiSanPhamVoiIdShop(idShop: number) {
        this.url = 'http://petslike.somee.com/api/loaisanpham/getallbyidshop/' + idShop;
        return this.apiService.get(this.url);
    }
